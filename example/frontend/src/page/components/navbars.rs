...
use seed::{prelude::*, *};
use seed_bootstrap::components::button::{self, Button};
use seed_bootstrap::components::dropdown::{self, Dropdown};
use seed_bootstrap::components::navbar::{Nav, NavBar, NavLink};
